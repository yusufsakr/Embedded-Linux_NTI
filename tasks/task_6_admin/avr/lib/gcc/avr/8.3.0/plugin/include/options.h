...
enum opt_code
{
  ...
  OPT_Wabi_ = 150,                           /* -Wabi= */
  OPT_Waddr_space_convert = 151,             /* -Waddr-space-convert */
  OPT_Waddress = 152,                        /* -Waddress */
  OPT_Waggregate_return = 153,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 154,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 155,                       /* -Waliasing */
  OPT_Walign_commons = 156,                  /* -Walign-commons */
  /* OPT_Waligned_new = 157, */              /* -Waligned-new */
  OPT_Waligned_new_ = 158,                   /* -Waligned-new= */
  OPT_Wall = 159,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 160,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 161,                     /* -Walloc-zero */
  OPT_Walloca = 162,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 163,            /* -Walloca-larger-than= */
  OPT_Wampersand = 164,                      /* -Wampersand */
  OPT_Wargument_mismatch = 165,              /* -Wargument-mismatch */
  OPT_Warray_bounds = 166,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 167,                  /* -Warray-bounds= */
  OPT_Warray_temporaries = 168,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 169,               /* -Wassign-intercept */
  OPT_Wattribute_alias = 170,                /* -Wattribute-alias */
  ...
  OPT_Wcast_align_strict = 187,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 188,             /* -Wcast-function-type */
  OPT_Wcast_qual = 189,                      /* -Wcast-qual */
  /* OPT_Wcatch_value = 190, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 191,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 192,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 193,           /* -Wcharacter-truncation */
  OPT_Wchkp = 194,                           /* -Wchkp */
  OPT_Wclass_memaccess = 195,                /* -Wclass-memaccess */
  ...
  OPT_Wdangling_else = 207,                  /* -Wdangling-else */
  ...
  OPT_Wdiv_by_zero = 218,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 219,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 220,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 221,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 222,            /* -Wduplicated-branches */
  ...
  OPT_Wexpansion_to_defined = 231,           /* -Wexpansion-to-defined */
  OPT_Wextra = 232,                          /* -Wextra */
  OPT_Wextra_semi = 233,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 234,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 235,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 236,                    /* -Wfloat-equal */
  /* OPT_Wformat = 237, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 238,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 239,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 240,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 241, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 242,               /* -Wformat-overflow= */
  OPT_Wformat_security = 243,                /* -Wformat-security */
  OPT_Wformat_signedness = 244,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 245, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 246,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 247,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 248,             /* -Wformat-zero-length */
  OPT_Wformat_ = 249,                        /* -Wformat= */
  OPT_Wframe_address = 250,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 251,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 252,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 253,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 254,           /* -Wfunction-elimination */
  OPT_Whsa = 255,                            /* -Whsa */
  OPT_Wif_not_aligned = 256,                 /* -Wif-not-aligned */
  ...
  /* OPT_Wimplicit_fallthrough = 260, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 261,          /* -Wimplicit-fallthrough= */
  ...
  OPT_Wint_in_bool_context = 272,            /* -Wint-in-bool-context */
  ...
  OPT_Wlto_type_mismatch = 289,              /* -Wlto-type-mismatch */
  OPT_Wmain = 290,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 291,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 292,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 293,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 294,         /* -Wmisleading-indentation */
  OPT_Wmissing_attributes = 295,             /* -Wmissing-attributes */
  ...
  OPT_Wnoexcept_type = 313,                  /* -Wnoexcept-type */
  ...
  OPT_Woverflow = 326,                       /* -Woverflow */
  OPT_Woverlength_strings = 327,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 328,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 329,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 330,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 331,                             /* -Wp, */
  OPT_Wpacked = 332,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 333,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 334,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 335,                         /* -Wpadded */
  OPT_Wparentheses = 336,                    /* -Wparentheses */
  OPT_Wpedantic = 337,                       /* -Wpedantic */
  /* OPT_Wplacement_new = 338, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 339,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 340,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 341,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 342,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 343,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 344,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 345,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 346,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 347,                       /* -Wprotocol */
  OPT_Wpsabi = 348,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 349,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 350,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 351,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 352,                /* -Wredundant-decls */
  OPT_Wregister = 353,                       /* -Wregister */
  OPT_Wreorder = 354,                        /* -Wreorder */
  OPT_Wrestrict = 355,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 356,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 357,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 358,           /* -Wscalar-storage-order */
  OPT_Wselector = 359,                       /* -Wselector */
  OPT_Wsequence_point = 360,                 /* -Wsequence-point */
  OPT_Wshadow = 361,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 362, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 363,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 364, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 365,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 366, */            /* -Wshadow=global */
  OPT_Wshadow_local = 367,                   /* -Wshadow=local */
  ...
  OPT_Wsizeof_pointer_div = 378,             /* -Wsizeof-pointer-div */
  ...
  OPT_Wstrict_aliasing = 382,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 383,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 384,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 385,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 386,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 387,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 388,          /* -Wstrict-selector-match */
  /* OPT_Wstringop_overflow = 389, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 390,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 391,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 392,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 393,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 394,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 395,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 396,       /* -Wsuggest-attribute=malloc */
  ...
  OPT_Wsurprising = 402,                     /* -Wsurprising */
  OPT_Wswitch = 403,                         /* -Wswitch */
  OPT_Wswitch_bool = 404,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 405,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 406,                    /* -Wswitch-enum */
  OPT_Wswitch_unreachable = 407,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 408,                      /* -Wsync-nand */
  OPT_Wsynth = 409,                          /* -Wsynth */
  OPT_Wsystem_headers = 410,                 /* -Wsystem-headers */
  OPT_Wtabs = 411,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 412,                /* -Wtarget-lifetime */
  ...
  OPT_Wundefined_do_loop = 423,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 424,                      /* -Wunderflow */
  OPT_Wuninitialized = 425,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 426,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 427, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 428, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 429,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 430,                         /* -Wunused */
  ...
  OPT_Wunused_const_variable_ = 434,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 435,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 436,                /* -Wunused-function */
  OPT_Wunused_label = 437,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 438,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 439,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 440,               /* -Wunused-parameter */
  OPT_Wunused_result = 441,                  /* -Wunused-result */
  OPT_Wunused_value = 442,                   /* -Wunused-value */
  OPT_Wunused_variable = 443,                /* -Wunused-variable */
  OPT_Wuse_without_only = 444,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 445,                   /* -Wuseless-cast */
  OPT_Wvarargs = 446,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 447,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 448,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 449,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 450,            /* -Wvirtual-move-assign */
  OPT_Wvla = 451,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 452,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 453,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 454,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 455,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 456,                       /* -Wzerotrip */
  OPT_Xassembler = 457,                      /* -Xassembler */
  OPT_Xlinker = 458,                         /* -Xlinker */
  OPT_Xpreprocessor = 459,                   /* -Xpreprocessor */
  OPT_Z = 460,                               /* -Z */
  OPT_ansi = 461,                            /* -ansi */
  OPT_aux_info = 462,                        /* -aux-info */
  /* OPT_aux_info_ = 463, */                 /* -aux-info= */
  OPT_auxbase = 464,                         /* -auxbase */
  OPT_auxbase_strip = 465,                   /* -auxbase-strip */
  OPT_c = 466,                               /* -c */
  OPT_coverage = 467,                        /* -coverage */
  OPT_cpp = 468,                             /* -cpp */
  OPT_cpp_ = 469,                            /* -cpp= */
  OPT_d = 470,                               /* -d */
  OPT_dumpbase = 471,                        /* -dumpbase */
  OPT_dumpdir = 472,                         /* -dumpdir */
  OPT_dumpfullversion = 473,                 /* -dumpfullversion */
  OPT_dumpmachine = 474,                     /* -dumpmachine */
  OPT_dumpspecs = 475,                       /* -dumpspecs */
  OPT_dumpversion = 476,                     /* -dumpversion */
  OPT_e = 477,                               /* -e */
  OPT_export_dynamic = 478,                  /* -export-dynamic */
  OPT_fPIC = 479,                            /* -fPIC */
  OPT_fPIE = 480,                            /* -fPIE */
  OPT_fRTS_ = 481,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 482,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 483,                   /* -fabi-version= */
  OPT_faccess_control = 484,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 485,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 486,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 487,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 488,                  /* -falign-commons */
  OPT_falign_functions = 489,                /* -falign-functions */
  OPT_falign_functions_ = 490,               /* -falign-functions= */
  OPT_falign_jumps = 491,                    /* -falign-jumps */
  OPT_falign_jumps_ = 492,                   /* -falign-jumps= */
  OPT_falign_labels = 493,                   /* -falign-labels */
  OPT_falign_labels_ = 494,                  /* -falign-labels= */
  OPT_falign_loops = 495,                    /* -falign-loops */
  OPT_falign_loops_ = 496,                   /* -falign-loops= */
  /* OPT_faligned_new = 497, */              /* -faligned-new */
  OPT_faligned_new_ = 498,                   /* -faligned-new= */
  OPT_fall_intrinsics = 499,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 500, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 501,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 502,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 503, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 504, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 505, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 506, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 507, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 508,            /* -fasan-shadow-offset= */
  OPT_fasm = 509,                            /* -fasm */
  OPT_fassociative_math = 510,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 511,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 512,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 513,                   /* -fauto-profile */
  OPT_fauto_profile_ = 514,                  /* -fauto-profile= */
  OPT_fautomatic = 515,                      /* -fautomatic */
  OPT_fbackslash = 516,                      /* -fbackslash */
  OPT_fbacktrace = 517,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 518,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 519,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 520,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 521,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 522,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 523,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 524,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 525,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 526,                        /* -fbuiltin */
  OPT_fbuiltin_ = 527,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 528,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 529,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 530,                    /* -fcall-saved- */
  OPT_fcall_used_ = 531,                     /* -fcall-used- */
  OPT_fcaller_saves = 532,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 533,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 534, */            /* -fcf-protection */
  OPT_fcf_protection_ = 535,                 /* -fcf-protection= */
  OPT_fcheck_array_temporaries = 536,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 537,                /* -fcheck-data-deps */
  OPT_fcheck_new = 538,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 539,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 540,                         /* -fcheck= */
  OPT_fchecking = 541,                       /* -fchecking */
  OPT_fchecking_ = 542,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 543,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 544,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 545,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 546,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 547,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 548,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 549,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 550,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 551, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 552,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 553,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 554,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 555, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 556,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 557,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 558,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 559,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 560,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 561,                       /* -fcilkplus */
  OPT_fcoarray_ = 562,                       /* -fcoarray= */
  OPT_fcode_hoisting = 563,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 564,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 565,                         /* -fcommon */
  OPT_fcompare_debug = 566,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 567,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 568,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 569,                   /* -fcompare-elim */
  OPT_fconcepts = 570,                       /* -fconcepts */
  OPT_fcond_mismatch = 571,                  /* -fcond-mismatch */
  OPT_fconserve_space = 572,                 /* -fconserve-space */
  OPT_fconserve_stack = 573,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 574,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 575,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 576,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 577,                       /* -fconvert= */
  OPT_fcprop_registers = 578,                /* -fcprop-registers */
  OPT_fcray_pointer = 579,                   /* -fcray-pointer */
  OPT_fcrossjumping = 580,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 581,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 582, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 583,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 584,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 585,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 586,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 587,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 588,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 589,                       /* -fdbg-cnt= */
  OPT_fdce = 590,                            /* -fdce */
  OPT_fdebug_cpp = 591,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 592,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 593,            /* -fdebug-types-section */
  OPT_fdec = 594,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 595,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 596,                       /* -fdec-math */
  OPT_fdec_static = 597,                     /* -fdec-static */
  OPT_fdec_structure = 598,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 599,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 600,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 601,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 602, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 603,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 604,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 605,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 606,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 607,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 608,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 609,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 610,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 611,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 612,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 613,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 614, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 615,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_generate_patch = 616,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 617,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 618,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 619,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 620,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 621, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 622,                /* -fdirectives-only */
  OPT_fdisable_ = 623,                       /* -fdisable- */
  OPT_fdollar_ok = 624,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 625,         /* -fdollars-in-identifiers */
  OPT_fdse = 626,                            /* -fdse */
  OPT_fdump_ = 627,                          /* -fdump- */
  OPT_fdump_ada_spec = 628,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 629,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 630, */                /* -fdump-core */
  OPT_fdump_final_insns = 631,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 632,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 633,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 634,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 635,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 636,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 637,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 638, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 639,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 640,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 641,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 642,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 643,                 /* -fearly-inlining */
  OPT_felide_constructors = 644,             /* -felide-constructors */
  OPT_felide_type = 645,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 646, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 647, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 648,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 649,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 650,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 651,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 652,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 653,                        /* -fenable- */
  OPT_fenforce_eh_specs = 654,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 655, */           /* -fenum-int-equiv */
  OPT_fexceptions = 656,                     /* -fexceptions */
  OPT_fexcess_precision_ = 657,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 658,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 659,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 660,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 661,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 662,                /* -fextern-tls-init */
  OPT_fexternal_blas = 663,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 664, */       /* -fexternal-templates */
  OPT_ff2c = 665,                            /* -ff2c */
  OPT_ffast_math = 666,                      /* -ffast-math */
  OPT_ffat_lto_objects = 667,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 668,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 669,               /* -ffinite-math-only */
  OPT_ffixed_ = 670,                         /* -ffixed- */
  OPT_ffixed_form = 671,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 672,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 673,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 674,                    /* -ffloat-store */
  OPT_ffor_scope = 675,                      /* -ffor-scope */
  /* OPT_fforce_addr = 676, */               /* -fforce-addr */
  OPT_fforward_propagate = 677,              /* -fforward-propagate */
  OPT_ffp_contract_ = 678,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 679,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 680,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 681,                      /* -ffpe-trap= */
  OPT_ffree_form = 682,                      /* -ffree-form */
  OPT_ffree_line_length_ = 683,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 684,          /* -ffree-line-length-none */
  OPT_ffreestanding = 685,                   /* -ffreestanding */
  OPT_ffriend_injection = 686,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 687,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 688,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 689,                   /* -ffunction-cse */
  OPT_ffunction_sections = 690,              /* -ffunction-sections */
  OPT_fgcse = 691,                           /* -fgcse */
  OPT_fgcse_after_reload = 692,              /* -fgcse-after-reload */
  OPT_fgcse_las = 693,                       /* -fgcse-las */
  OPT_fgcse_lm = 694,                        /* -fgcse-lm */
  OPT_fgcse_sm = 695,                        /* -fgcse-sm */
  OPT_fgimple = 696,                         /* -fgimple */
  OPT_fgnat_encodings_ = 697,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 698,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 699,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 700,                         /* -fgnu-tm */
  OPT_fgnu_unique = 701,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 702,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 703,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 704,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 705,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 706,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 707,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 708,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 709,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 710,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 711,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 712,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 713,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 714,                       /* -fgraphite */
  OPT_fgraphite_identity = 715,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 716,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 717, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 718, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 719, */                     /* -fhelp */
  /* OPT_fhelp_ = 720, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 721,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 722, */                /* -fhonor-std */
  OPT_fhosted = 723,                         /* -fhosted */
  /* OPT_fhuge_objects = 724, */             /* -fhuge-objects */
  OPT_fident = 725,                          /* -fident */
  OPT_fif_conversion = 726,                  /* -fif-conversion */
  OPT_fif_conversion2 = 727,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 728,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 729,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 730,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 731,             /* -fimplicit-templates */
  OPT_findirect_inlining = 732,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 733,         /* -finhibit-size-directive */
  OPT_finit_character_ = 734,                /* -finit-character= */
  OPT_finit_derived = 735,                   /* -finit-derived */
  OPT_finit_integer_ = 736,                  /* -finit-integer= */
  OPT_finit_local_zero = 737,                /* -finit-local-zero */
  OPT_finit_logical_ = 738,                  /* -finit-logical= */
  OPT_finit_real_ = 739,                     /* -finit-real= */
  OPT_finline = 740,                         /* -finline */
  OPT_finline_atomics = 741,                 /* -finline-atomics */
  OPT_finline_functions = 742,               /* -finline-functions */
  OPT_finline_functions_called_once = 743,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 744, */            /* -finline-limit- */
  OPT_finline_limit_ = 745,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 746,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 747,         /* -finline-small-functions */
  OPT_finput_charset_ = 748,                 /* -finput-charset= */
  OPT_finstrument_functions = 749,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 750,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 751,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 752,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 753,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 754,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 755,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 756,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 757, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 758,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 759,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 760,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 761,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 762, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 763,                    /* -fipa-profile */
  OPT_fipa_pta = 764,                        /* -fipa-pta */
  OPT_fipa_pure_const = 765,                 /* -fipa-pure-const */
  OPT_fipa_ra = 766,                         /* -fipa-ra */
  OPT_fipa_reference = 767,                  /* -fipa-reference */
  OPT_fipa_sra = 768,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 769, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 770,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 771,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 772,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 773,              /* -fira-loop-pressure */
  OPT_fira_region_ = 774,                    /* -fira-region= */
  OPT_fira_share_save_slots = 775,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 776,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 777,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 778,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 779,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 780,               /* -fivar-visibility= */
  OPT_fivopts = 781,                         /* -fivopts */
  OPT_fjump_tables = 782,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 783,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 784,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 785,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 786,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 787,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 788, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 789,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 790,             /* -fleading-underscore */
  OPT_flifetime_dse = 791,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 792,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 793,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 794,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 795,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 796,                    /* -flocal-ivars */
  /* OPT_floop_block = 797, */               /* -floop-block */
  /* OPT_floop_flatten = 798, */             /* -floop-flatten */
  OPT_floop_interchange = 799,               /* -floop-interchange */
  OPT_floop_nest_optimize = 800,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 801, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 802,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 803, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 804,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 805,                      /* -flra-remat */
  OPT_flto = 806,                            /* -flto */
  OPT_flto_compression_level_ = 807,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 808,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 809,                 /* -flto-partition= */
  OPT_flto_report = 810,                     /* -flto-report */
  OPT_flto_report_wpa = 811,                 /* -flto-report-wpa */
  OPT_flto_ = 812,                           /* -flto= */
  OPT_fltrans = 813,                         /* -fltrans */
  OPT_fltrans_output_list_ = 814,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 815,              /* -fmacro-prefix-map= */
  OPT_fmath_errno = 816,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 817,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 818,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 819,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 820,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 821,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 822,                     /* -fmem-report */
  OPT_fmem_report_wpa = 823,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 824,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 825,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 826,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 827,                /* -fmessage-length= */
  OPT_fmodule_private = 828,                 /* -fmodule-private */
  OPT_fmodulo_sched = 829,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 830,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 831,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 832,                  /* -fms-extensions */
  /* OPT_fmudflap = 833, */                  /* -fmudflap */
  /* OPT_fmudflapir = 834, */                /* -fmudflapir */
  /* OPT_fmudflapth = 835, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 836, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 837, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 838,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 839,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 840,                   /* -fnext-runtime */
  OPT_fnil_receivers = 841,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 842,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 843,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 844, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 845,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 846,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 847,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 848,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 849,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 850,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 851,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 852,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 853,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 854,                   /* -foffload-abi= */
  OPT_foffload_ = 855,                       /* -foffload= */
  OPT_fomit_frame_pointer = 856,             /* -fomit-frame-pointer */
  OPT_fopenacc = 857,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 858,                   /* -fopenacc-dim= */
  OPT_fopenmp = 859,                         /* -fopenmp */
  OPT_fopenmp_simd = 860,                    /* -fopenmp-simd */
  OPT_foperator_names = 861,                 /* -foperator-names */
  OPT_fopt_info = 862,                       /* -fopt-info */
  OPT_fopt_info_ = 863,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 864, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 865,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 866,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 867, */           /* -foptional-diags */
  OPT_fpack_derived = 868,                   /* -fpack-derived */
  OPT_fpack_struct = 869,                    /* -fpack-struct */
  OPT_fpack_struct_ = 870,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 871,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 872,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 873,              /* -fpcc-struct-return */
  OPT_fpch_deps = 874,                       /* -fpch-deps */
  OPT_fpch_preprocess = 875,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 876,                     /* -fpeel-loops */
  OPT_fpeephole = 877,                       /* -fpeephole */
  OPT_fpeephole2 = 878,                      /* -fpeephole2 */
  OPT_fpermissive = 879,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 880,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 881,                            /* -fpic */
  OPT_fpie = 882,                            /* -fpie */
  OPT_fplan9_extensions = 883,               /* -fplan9-extensions */
  OPT_fplt = 884,                            /* -fplt */
  OPT_fplugin_arg_ = 885,                    /* -fplugin-arg- */
  OPT_fplugin_ = 886,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 887,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 888,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 889,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 890,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 891,                   /* -fpreprocessed */
  OPT_fpretty_templates = 892,               /* -fpretty-templates */
  OPT_fprintf_return_value = 893,            /* -fprintf-return-value */
  OPT_fprofile = 894,                        /* -fprofile */
  OPT_fprofile_abs_path = 895,               /* -fprofile-abs-path */
  ...
  OPT_fprofile_update_ = 903,                /* -fprofile-update= */
  OPT_fprofile_use = 904,                    /* -fprofile-use */
  OPT_fprofile_use_ = 905,                   /* -fprofile-use= */
  OPT_fprofile_values = 906,                 /* -fprofile-values */
  OPT_fprotect_parens = 907,                 /* -fprotect-parens */
  OPT_frandom_seed = 908,                    /* -frandom-seed */
  OPT_frandom_seed_ = 909,                   /* -frandom-seed= */
  OPT_frange_check = 910,                    /* -frange-check */
  OPT_freal_4_real_10 = 911,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 912,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 913,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 914,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 915,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 916,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 917,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 918,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 919,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 920,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 921,                /* -frecord-marker=8 */
  OPT_frecursive = 922,                      /* -frecursive */
  OPT_free = 923,                            /* -free */
  ...
  OPT_frtti = 941,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 942,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 943,             /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 944,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 945,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 946,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 947,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 948,                      /* -fsanitize= */
  ...
  OPT_fself_test_ = 978,                     /* -fself-test= */
  OPT_fsemantic_interposition = 979,         /* -fsemantic-interposition */
  OPT_fshort_enums = 980,                    /* -fshort-enums */
  OPT_fshort_wchar = 981,                    /* -fshort-wchar */
  OPT_fshow_column = 982,                    /* -fshow-column */
  OPT_fshrink_wrap = 983,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 984,           /* -fshrink-wrap-separate */
  ...
  OPT_fsplit_loops = 994,                    /* -fsplit-loops */
  OPT_fsplit_paths = 995,                    /* -fsplit-paths */
  OPT_fsplit_stack = 996,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 997,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 998, */                 /* -fsquangle */
  OPT_fssa_backprop = 999,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 1000,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1001,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1002,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1003, */             /* -fstack-check */
  OPT_fstack_check_ = 1004,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1005,        /* -fstack-clash-protection */
  ...
  OPT_fstore_merging = 1017,                 /* -fstore-merging */
  ...
  /* OPT_fstrong_eval_order = 1024, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1025,            /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 1026,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1027,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1028,                      /* -ftabstop= */
  ...
  OPT_mabsdata = 1192,                       /* -mabsdata */
  OPT_maccumulate_args = 1193,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1194,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1195,                /* -mcall-prologues */
  OPT_mdeb = 1196,                           /* -mdeb */
  OPT_mfract_convert_truncate = 1197,        /* -mfract-convert-truncate */
  OPT_mgas_isr_prologues = 1198,             /* -mgas-isr-prologues */
  OPT_mint8 = 1199,                          /* -mint8 */
  OPT_mlog_ = 1200,                          /* -mlog= */
  OPT_mmain_is_OS_task = 1201,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 1202,                          /* -mmcu= */
  OPT_mn_flash_ = 1203,                      /* -mn-flash= */
  OPT_mno_interrupts = 1204,                 /* -mno-interrupts */
  OPT_morder1 = 1205,                        /* -morder1 */
  OPT_morder2 = 1206,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1207,              /* -mpmem-wrap-around */
  OPT_mrelax = 1208,                         /* -mrelax */
  OPT_mrmw = 1209,                           /* -mrmw */
  OPT_mshort_calls = 1210,                   /* -mshort-calls */
  OPT_mskip_bug = 1211,                      /* -mskip-bug */
  OPT_msp8 = 1212,                           /* -msp8 */
  OPT_mstrict_X = 1213,                      /* -mstrict-X */
  OPT_mtiny_stack = 1214,                    /* -mtiny-stack */
  OPT_n = 1215,                              /* -n */
  OPT_no_canonical_prefixes = 1216,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1217,              /* -no-integrated-cpp */
  OPT_no_pie = 1218,                         /* -no-pie */
  OPT_nocpp = 1219,                          /* -nocpp */
  OPT_nodefaultlibs = 1220,                  /* -nodefaultlibs */
  OPT_nodevicelib = 1221,                    /* -nodevicelib */
  OPT_nostartfiles = 1222,                   /* -nostartfiles */
  OPT_nostdinc = 1223,                       /* -nostdinc */
  OPT_nostdinc__ = 1224,                     /* -nostdinc++ */
  OPT_nostdlib = 1225,                       /* -nostdlib */
  OPT_o = 1226,                              /* -o */
  OPT_p = 1227,                              /* -p */
  OPT_pass_exit_codes = 1228,                /* -pass-exit-codes */
  /* OPT_pedantic = 1229, */                 /* -pedantic */
  OPT_pedantic_errors = 1230,                /* -pedantic-errors */
  OPT_pg = 1231,                             /* -pg */
  OPT_pie = 1232,                            /* -pie */
  OPT_pipe = 1233,                           /* -pipe */
  OPT_print_file_name_ = 1234,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1235,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1236,          /* -print-multi-directory */
  OPT_print_multi_lib = 1237,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1238,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1239,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1240,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1241,               /* -print-prog-name= */
  OPT_print_search_dirs = 1242,              /* -print-search-dirs */
  OPT_print_sysroot = 1243,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1244,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1245,                          /* -quiet */
  OPT_r = 1246,                              /* -r */
  OPT_remap = 1247,                          /* -remap */
  OPT_s = 1248,                              /* -s */
  OPT_save_temps = 1249,                     /* -save-temps */
  OPT_save_temps_ = 1250,                    /* -save-temps= */
  OPT_shared = 1251,                         /* -shared */
  OPT_shared_libgcc = 1252,                  /* -shared-libgcc */
  /* OPT_specs = 1253, */                    /* -specs */
  OPT_specs_ = 1254,                         /* -specs= */
  OPT_static = 1255,                         /* -static */
  OPT_static_libasan = 1256,                 /* -static-libasan */
  OPT_static_libgcc = 1257,                  /* -static-libgcc */
  OPT_static_libgfortran = 1258,             /* -static-libgfortran */
  OPT_static_libgo = 1259,                   /* -static-libgo */
  OPT_static_liblsan = 1260,                 /* -static-liblsan */
  OPT_static_libmpx = 1261,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1262,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1263,               /* -static-libstdc++ */
  OPT_static_libtsan = 1264,                 /* -static-libtsan */
  OPT_static_libubsan = 1265,                /* -static-libubsan */
  OPT_static_pie = 1266,                     /* -static-pie */
  /* OPT_std_c__03 = 1267, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1268, */                /* -std=c++0x */
  OPT_std_c__11 = 1269,                      /* -std=c++11 */
  OPT_std_c__14 = 1270,                      /* -std=c++14 */
  OPT_std_c__17 = 1271,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1272, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1273, */                /* -std=c++1z */
  OPT_std_c__2a = 1274,                      /* -std=c++2a */
  OPT_std_c__98 = 1275,                      /* -std=c++98 */
  OPT_std_c11 = 1276,                        /* -std=c11 */
  OPT_std_c17 = 1277,                        /* -std=c17 */
  /* OPT_std_c18 = 1278, */                  /* -std=c18 */
  /* OPT_std_c1x = 1279, */                  /* -std=c1x */
  /* OPT_std_c89 = 1280, */                  /* -std=c89 */
  OPT_std_c90 = 1281,                        /* -std=c90 */
  OPT_std_c99 = 1282,                        /* -std=c99 */
  /* OPT_std_c9x = 1283, */                  /* -std=c9x */
  OPT_std_f2003 = 1284,                      /* -std=f2003 */
  OPT_std_f2008 = 1285,                      /* -std=f2008 */
  OPT_std_f2008ts = 1286,                    /* -std=f2008ts */
  OPT_std_f2018 = 1287,                      /* -std=f2018 */
  OPT_std_f95 = 1288,                        /* -std=f95 */
  OPT_std_gnu = 1289,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1290, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1291, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1292,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1293,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1294,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1295, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1296, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1297,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1298,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1299,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1300,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1301, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1302, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1303, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1304,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1305,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1306, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1307, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1308,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1309, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1310, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1311, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1312, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1313, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1314,                     /* -std=legacy */
  OPT_symbolic = 1315,                       /* -symbolic */
  OPT_t = 1316,                              /* -t */
  OPT_time = 1317,                           /* -time */
  OPT_time_ = 1318,                          /* -time= */
  OPT_traditional = 1319,                    /* -traditional */
  OPT_traditional_cpp = 1320,                /* -traditional-cpp */
  OPT_trigraphs = 1321,                      /* -trigraphs */
  OPT_u = 1322,                              /* -u */
  OPT_undef = 1323,                          /* -undef */
  OPT_v = 1324,                              /* -v */
  OPT_version = 1325,                        /* -version */
  OPT_w = 1326,                              /* -w */
  OPT_wrapper = 1327,                        /* -wrapper */
  OPT_x = 1328,                              /* -x */
  OPT_z = 1329,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
